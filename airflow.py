...
run_get_data = BashOperator(
    ...
    bash_command="python3 /mastodon/extractor.py",
    dag=dag,
)
...
run_mapper = BashOperator(
    ...
    bash_command="hadoop dfs -cat /Mostodon/Raw/mastodon_data.json | python3 /mastodon / mapper.py | sort -k1,1",
    dag=dag,
)
...
run_reducer = BashOperator(
    ...
    bash_command="python3 /mastodon/reducer.py",
    dag=dag,
)
...
run_insert_hbase = BashOperator(
    ...
    bash_command='python3 /mastodon/hbase_script.py',
    dag=dag
)

# Set task dependencies
run_get_data >> run_mapper >> run_reducer >> run_insert_hbase
